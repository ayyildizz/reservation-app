...
export class BeautyTable extends React.Component {
  state = {
    tests: []
  }
  ...
  constructor(props) {
    ...
    this.resourceData = [
      ...
      { Text: 'Armağan', Id: 14, Color: '#DEC8F4' },
      { Text: 'Atlas', Id: 15, Color: '#81BED2' },
      { Text: 'Aybars', Id: 16, Color: '#DEC8F4' },
      { Text: 'Karaca', Id: 17, Color: '#81BED2' },
      { Text: 'Room1', Id: 18, Color: '#DEC8F4' },
      { Text: 'Room2', Id: 19, Color: '#81BED2' },
    ];
