...
import CoiffeurTable from "./CoiffeurTable";
...
class WomenSection extends React.Component {
    ...
    render() {
        let dataMan = new DataManager({
            url: "http://localhost:3500/api/getWomenAppointments",
        ...
        return (
            <div class="text-center">
                ...
                < CoiffeurTable tests = {this.state.tests} dataMan = {dataMan} />
